                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <h1 style="margin:0 0 20px; font-family:Arial, Helvetica, sans-serif; font-size:22px; color:#0b0b0b;">
                                Hi {{ explode(' ', trim($lead->name))[0] ?: 'there' }}, thanks for getting in touch!
                            </h1>
                            <p style="margin:0 0 24px; font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:1.7; color:#374151;">
                                We've received your message and one of our team members will reach out to you within <strong>24 hours</strong>.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f9fafb; border:1px solid #e5e7eb; border-radius:10px; margin-bottom:28px;">
                                <tr>
                                    <td style="padding:20px 24px;">
                                        ...
                                        <p style="margin:0 0 {{ $lead->message ? '8px' : '0' }}; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#374151;"><strong style="color:#0b0b0b;">Email:</strong> {{ $lead->email }}</p>
                                        @if($lead->message)
                                        <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#374151; white-space:pre-line;"><strong style="color:#0b0b0b;">Message:</strong> {{ $lead->message }}</p>
                                        @endif
                                    </td>
                                </tr>
                            </table>
