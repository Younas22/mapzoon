        ...
        <div class="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div class="reveal reveal-delay-2 order-1 lg:order-2">
                ...
                <div class="mt-8 space-y-4">
                    <a href="tel:{{ $settings->phone ?? '+923266987997' }}" class="glass-dark flex items-center gap-4 rounded-none p-4 transition hover:bg-white/15">
                        ...
                        <span>
                            ...
                            <span class="block text-base font-semibold text-white">{{ $settings->phone ?? '0326 6987997' }}</span>
                        </span>
                    </a>
                    ...
                    <a href="{{ $settings->whatsappUrl() }}" target="_blank" rel="noopener noreferrer" class="glass-dark flex items-center gap-4 rounded-none p-4 transition hover:bg-white/15">
                        ...
                        <span>
                            <span class="block text-xs font-medium text-slate-400">WhatsApp Us</span>
                            <span class="block text-base font-semibold text-white">{{ $settings->phone ?? '0326 6987997' }}</span>
                        </span>
                    </a>
