        ...
        <section class="relative bg-white py-20 lg:py-28">
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                        ...
                        @foreach ($plans as $plan)
                            <div class="reveal relative flex flex-col rounded-2xl border {{ $plan['highlight'] ? 'border-primary-500 bg-primary-600 text-white shadow-xl shadow-primary-500/30' : 'border-slate-200 bg-white shadow-sm' }} p-8">
                                ...
                                <a href="{{ route('contact.page') }}"
                                   class="mt-8 block rounded-none px-5 py-3 text-center text-sm font-semibold transition hover:-translate-y-0.5 {{ $plan['highlight'] ? 'bg-white text-primary-600 hover:bg-primary-50 shadow-md' : 'bg-primary-500 text-white hover:bg-primary-600 shadow-md shadow-primary-500/30' }}">
                                    {{ $plan['cta'] }}
                                </a>
                            </div>
                        @endforeach
                ...
                <div class="reveal mt-16 rounded-2xl bg-slate-900 p-8 text-center text-white lg:p-12">
                    ...
                    <a href="{{ route('contact.page') }}" class="mt-6 inline-flex items-center gap-2 rounded-none bg-primary-500 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-primary-500/30 transition hover:-translate-y-0.5 hover:bg-primary-600">
