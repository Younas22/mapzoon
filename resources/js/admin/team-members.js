...
export default function teamMemberManager(config) {
    return {
        config,
        modalOpen: false,
        ...
        async openEdit(id) {
            ...
            this.form = { ...emptyTeamMemberForm(), ...data.teamMember };
            this.photoPreview = data.teamMember.photo_url ?? null;
        ...
        async submit() {
            ...
            Object.entries(this.form).forEach(([key, value]) => {
                if (key === 'id' || key === 'photo_url' || value === null) return;
