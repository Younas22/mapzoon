...
import { jobApplicationManager, jobApplicationShow } from './admin/job-applications';
...
import { caseStudyManager, caseStudyForm } from './admin/case-studies';
...
Alpine.data('jobApplicationManager', jobApplicationManager);
Alpine.data('jobApplicationShow', jobApplicationShow);
...
Alpine.data('caseStudyManager', caseStudyManager);
Alpine.data('caseStudyForm', caseStudyForm);
